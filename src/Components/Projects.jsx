...
const Projects = () => {
  ...
  return (
    <div className="px-24 min-h-screen pt-20 pb-20 bg-slate-50">
      <div>
        <SectionTitle title="Jack Gross" />
        <div className="relative w-fit">
          <h3 className="text-6xl font-semibold w-[15ch] leading-tight">
            Look at My Products.
          </h3>
          <img src={projectImg} alt="view my projects" className="absolute -right-20 top-0"/>
        </div>
      </div>
      <div className="mt-12">
...
function ProjectCard({ src, title, desc }) {
  return (
    <div className="border border-solid overflow-hidden border-gray-200 flex rounded-lg shadow-md hover:shadow-2xl transition-all ease-in-out">
      <div className="overflow-hidden h-[300px] w-[600px] rounded-s-lg">
